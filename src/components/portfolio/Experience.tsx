    ...
    <section id="experience" className="section-padding relative">
      <div className="mx-auto max-w-5xl px-6">
        <SectionHeading
          ...
          description="Roles where I shipped impact-driven software."
        />
        ...
        <div className="relative">
          ...
          {timeline.map((t, i) => (
            <motion.div
              ...
              className={`relative mb-10 grid md:grid-cols-2 md:gap-12 ${
              ...
              <div className={`pl-12 md:pl-0 ${i % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12 [direction:ltr]"}`}>
                ...
                <div className="rounded-2xl glass p-6 [direction:ltr]">
                  ...
                  <div className="mt-4 flex flex-wrap gap-1.5">
                    {t.focus.map((f) => (
                      <span key={f} className="rounded-full border border-border bg-secondary/40 px-2.5 py-0.5 text-[11px] font-mono text-muted-foreground">
                        {f}
                      </span>
                    ))}
                  </div>
