...
export function About() {
    return (<section id="about" className="section-padding relative">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading eyebrow="About Me" title="Passionate about scalable systems" description="I am a passionate Software Engineer with experience in Java, Spring Boot, Microservices, REST APIs, SQL, React, and System Design. I enjoy building scalable applications, solving complex problems, and continuously learning modern technologies."/>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {highlights.map((h, i) => (<motion.div key={h.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.08 }} className="group relative rounded-2xl glass p-6 transition-all hover:-translate-y-1 hover:border-brand/40">
