...
const testimonials = [
  ...
  {
    quote:
      "A rare combination of strong fundamentals, pragmatic delivery, and curiosity. He raised the bar of our service quality.",
    ...
    <section className="section-padding relative">
      <div className="mx-auto max-w-7xl px-6">
        <SectionHeading
          ...
          description="Voices from teammates, mentors, and collaborators."
        />
